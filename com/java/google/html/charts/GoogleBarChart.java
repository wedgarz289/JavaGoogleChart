...
public class GoogleBarChart
{
  ...
  public GoogleBarChart(String func_name, String id_element)
  {
  ...
  public void setOptionBarChart(String option)
  {
    this.optionChart = "     // Set chart options\n" +
                       "     var options = {" + option + "};\n";
  }
  public void generateCodeBarChart(Map<String,Double> xy,String label_column_x,String label_column_y)
  {
    ...
    this.functionsChartText = "    // Callback that draws the pie chart for " + this.func_name +  ".\n" +
                              ...
                              "     data.addColumn('string', '" + label_column_x + "');\n" +
                              "     data.addColumn('number', '" + label_column_y + "');\n"  +
                              "     data.addRows([\n";
    int count = 0;
    ...
    this.functionsChartText = this.functionsChartText +
      ...
      "     var chart = new google.visualization.ColumnChart(document.getElementById('" + this.id_element + "'));\n" +
      "     chart.draw(data,options);\n" +
      "    }\n";
  }
  public void generateCodeBarChart(double[][] table,String[] table_label)
  {
    this.drawChartText      = this.drawChartText +
                              "    // Draw the pie chart for " + this.func_name + " when Charts is loaded.\n" +
                              "    google.charts.setOnLoadCallback(" + this.func_name + ");\n";

...
public class GoogleAreaChart
{
  ...
  public GoogleAreaChart(String func_name, String id_element)
  {
  ...
  public void setOptionAreaChart(String option)
  {
    this.optionChart = "     // Set chart options\n" +
                       "     var options = {" + option + "};\n";
  }

  public void generateCodeAreaChart(double[][] table,String[] table_label)
  {
    ...
    this.functionsChartText = this.functionsChartText +
      ...
      "     var chart = new google.visualization.AreaChart(document.getElementById('" + this.id_element + "'));\n" +
      "     chart.draw(data,options);\n" +
      "    }\n";
  }
  public void generateCodeAreaChart(String[] column_1,double[][] table,String[] table_label)
  {
    this.drawChartText      = this.drawChartText +
                              "    // Draw the pie chart for " + this.func_name + " when Charts is loaded.\n" +
                              "    google.charts.setOnLoadCallback(" + this.func_name + ");\n";
